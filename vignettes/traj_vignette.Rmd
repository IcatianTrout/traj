...
Two outlying values were detected in measure 18 of trajectories ID23 and ID110 and were capped to more likely values according to the distribution of m18 (see Appendix B). Once the measures are computed, we use the `Step2Selection` function to extract the measures that best characterize the trajectories.
